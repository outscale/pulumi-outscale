...
import { Tag } from "@pulumi/outscale/tag";


const script = readFileSync('./hello_startup.sh', 'utf-8');

const keypair = new outscale.Keypair("hello", {
    keypairName: "hello", 
})
...
const security_group_rule_http = new outscale.SecurityGroupRule("hello-sg-http", {
    flow: "Inbound",
    securityGroupId: security_group.id,
    fromPortRange: 8080,
    toPortRange: 8080,
