...
require (
	...
	github.com/outscale/terraform-provider-outscale v1.6.0
...
require (
	...
	github.com/outscale/goutils/sdk v0.0.3 // indirect
	github.com/outscale/osc-sdk-go/v3 v3.0.0-rc.2 // indirect
