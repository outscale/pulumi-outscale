...
func Test_ResourceMapping(t *testing.T) {
	...
	expected := map[string]tokens.Type{
		...
		"outscale_net_peering_acceptation":           outscaleResource(outscaleMod, "NetPeeringAcceptation"),
		...
		"outscale_volume_link":                       outscaleResource(outscaleMod, "VolumeLink"),
		...
		"outscale_main_route_table_link":       outscaleResource(outscaleMod, "MainRouteTableLink"),
		"outscale_load_balancer_listener_rule": outscaleResource(outscaleMod, "LoadBalancerListenerRule"),
		"outscale_user_group":                  outscaleResource(outscaleMod, "UserGroup"),
		"outscale_user":                        outscaleResource(outscaleMod, "User"),
		"outscale_policy_version":              outscaleResource(outscaleMod, "PolicyVersion"),
		"outscale_policy":                      outscaleResource(outscaleMod, "Policy"),
	}
	...
	for name, _ := range provider.Resources {
		seen[name] = false
	}
...
func Test_DataSourceMapping(t *testing.T) {
	expected := map[string]tokens.ModuleMember{
		...
		"outscale_users":                         outscaleDataSource(outscaleMod, "getUsers"),
		"outscale_policies_linked_to_user_group": outscaleDataSource(outscaleMod, "getPoliciesLinkedToUserGroup"),
		"outscale_user":                          outscaleDataSource(outscaleMod, "getUser"),
		"outscale_policies_linked_to_user":       outscaleDataSource(outscaleMod, "getPoliciesLinkedToUser"),
		"outscale_entities_linked_to_policy":     outscaleDataSource(outscaleMod, "getEntitiesLinkedToPolicy"),
		"outscale_user_group":                    outscaleDataSource(outscaleMod, "getUserGroup"),
		"outscale_user_groups_per_user":          outscaleDataSource(outscaleMod, "getUserGroupsPerUser"),
		"outscale_policy":                        outscaleDataSource(outscaleMod, "getPolicy"),
		"outscale_load_balancer_listener_rule":   outscaleDataSource(outscaleMod, "getLoadBalancerListenerRule"),
		"outscale_policies":                      outscaleDataSource(outscaleMod, "getPolicies"),
		"outscale_load_balancer_listener_rules":  outscaleDataSource(outscaleMod, "getLoadBalancerListenerRules"),
		"outscale_public_catalog":                outscaleDataSource(outscaleMod, "getPublicCatalog"),
		"outscale_user_groups":                   outscaleDataSource(outscaleMod, "getUserGroups"),
		"outscale_tags":                          outscaleDataSource(outscaleMod, "getTags"),
	}
	...
	for name, _ := range provider.DataSources {
		seen[name] = false
	}
