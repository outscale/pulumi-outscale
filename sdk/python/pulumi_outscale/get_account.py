...
def get_account_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccountResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('outscale:index/getAccount:getAccount', __args__, opts=opts, typ=GetAccountResult)
    return __ret__.apply(lambda __response__: GetAccountResult(
        account_id=pulumi.get(__response__, 'account_id'),
        additional_emails=pulumi.get(__response__, 'additional_emails'),
        ...
        state_province=pulumi.get(__response__, 'state_province'),
        vat_number=pulumi.get(__response__, 'vat_number'),
