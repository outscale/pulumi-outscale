...
namespace Pulumi.Outscale.Inputs
{
    ...
    public sealed class SecurityGroupOutboundRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.SecurityGroupOutboundRuleSecurityGroupsMemberArgs>? _securityGroupsMembers;

        /// <summary>
        /// Information about one or more source or destination security groups.
        /// </summary>
        public InputList<Inputs.SecurityGroupOutboundRuleSecurityGroupsMemberArgs> SecurityGroupsMembers
        {
            get => _securityGroupsMembers ?? (_securityGroupsMembers = new InputList<Inputs.SecurityGroupOutboundRuleSecurityGroupsMemberArgs>());
