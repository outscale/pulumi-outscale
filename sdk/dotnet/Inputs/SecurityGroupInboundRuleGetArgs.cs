...
namespace Pulumi.Outscale.Inputs
{
    ...
    public sealed class SecurityGroupInboundRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<ImmutableDictionary<string, object>>? _securityGroupsMembers;

        /// <summary>
        /// Information about one or more source or destination security groups.
        /// </summary>
        public InputList<ImmutableDictionary<string, object>> SecurityGroupsMembers
        {
            get => _securityGroupsMembers ?? (_securityGroupsMembers = new InputList<ImmutableDictionary<string, object>>());
