...
namespace Pulumi.Outscale.Inputs
{
    ...
    public sealed class VmNicArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("linkNics")]
        private InputList<Inputs.VmNicLinkNicArgs>? _linkNics;

        /// <summary>
        /// Information about the network interface card (NIC).
        /// </summary>
        public InputList<Inputs.VmNicLinkNicArgs> LinkNics
        {
            get => _linkNics ?? (_linkNics = new InputList<Inputs.VmNicLinkNicArgs>());
            set => _linkNics = value;
        }

        [Input("linkPublicIps")]
        private InputList<Inputs.VmNicLinkPublicIpArgs>? _linkPublicIps;

        /// <summary>
        /// Information about the public IP associated with the NIC.
        /// </summary>
        public InputList<Inputs.VmNicLinkPublicIpArgs> LinkPublicIps
        {
            get => _linkPublicIps ?? (_linkPublicIps = new InputList<Inputs.VmNicLinkPublicIpArgs>());
        ...
        [Input("privateIps")]
        private InputList<Inputs.VmNicPrivateIpArgs>? _privateIps;

        /// <summary>
        /// One or more private IPs of the VM.
        /// </summary>
        public InputList<Inputs.VmNicPrivateIpArgs> PrivateIps
        {
            get => _privateIps ?? (_privateIps = new InputList<Inputs.VmNicPrivateIpArgs>());
        ...
        private InputList<Inputs.VmNicSecurityGroupArgs>? _securityGroups;

        /// <summary>
        /// One or more security groups associated with the VM.
        /// </summary>
        public InputList<Inputs.VmNicSecurityGroupArgs> SecurityGroups
        {
            get => _securityGroups ?? (_securityGroups = new InputList<Inputs.VmNicSecurityGroupArgs>());
        ...
        public static new VmNicArgs Empty => new VmNicArgs();
    }
}
