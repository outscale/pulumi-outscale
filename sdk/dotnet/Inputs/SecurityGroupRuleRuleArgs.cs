...
namespace Pulumi.Outscale.Inputs
{
    ...
    public sealed class SecurityGroupRuleRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.SecurityGroupRuleRuleSecurityGroupsMemberArgs>? _securityGroupsMembers;

        /// <summary>
        /// Information about one or more source or destination security groups.
        /// </summary>
        public InputList<Inputs.SecurityGroupRuleRuleSecurityGroupsMemberArgs> SecurityGroupsMembers
        {
            get => _securityGroupsMembers ?? (_securityGroupsMembers = new InputList<Inputs.SecurityGroupRuleRuleSecurityGroupsMemberArgs>());
        ...
        public SecurityGroupRuleRuleArgs()
        {
        }
        public static new SecurityGroupRuleRuleArgs Empty => new SecurityGroupRuleRuleArgs();
    }
}
