 ...
 * ```
 */
export function getNetsOutput(args?: GetNetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getNets:getNets", {
        "filters": args.filters,
        "netIds": args.netIds,
    }, opts);
}
