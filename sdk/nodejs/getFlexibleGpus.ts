 ...
 * ```
 */
export function getFlexibleGpusOutput(args?: GetFlexibleGpusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFlexibleGpusResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getFlexibleGpus:getFlexibleGpus", {
        "filters": args.filters,
    }, opts);
}
