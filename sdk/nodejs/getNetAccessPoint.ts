 ...
 * ```
 */
export function getNetAccessPointOutput(args?: GetNetAccessPointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetAccessPointResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getNetAccessPoint:getNetAccessPoint", {
        "filters": args.filters,
    }, opts);
}
