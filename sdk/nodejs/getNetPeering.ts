 ...
 * ```
 */
export function getNetPeeringOutput(args?: GetNetPeeringOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetPeeringResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getNetPeering:getNetPeering", {
        "filters": args.filters,
    }, opts);
}
