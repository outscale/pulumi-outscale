 ...
 * ```
 */
export function getClientGatewayOutput(args?: GetClientGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClientGatewayResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getClientGateway:getClientGateway", {
        "clientGatewayId": args.clientGatewayId,
        "filters": args.filters,
    }, opts);
}
