 ...
 * ```
 */
export function getNatServiceOutput(args?: GetNatServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNatServiceResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getNatService:getNatService", {
        "filters": args.filters,
        "natServiceId": args.natServiceId,
    }, opts);
}
