 ...
 * ```
 */
export function getNetAccessPointsOutput(args?: GetNetAccessPointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetAccessPointsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getNetAccessPoints:getNetAccessPoints", {
        "filters": args.filters,
    }, opts);
}
