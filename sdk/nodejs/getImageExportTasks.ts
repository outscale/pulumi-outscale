 ...
 * ```
 */
export function getImageExportTasksOutput(args?: GetImageExportTasksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetImageExportTasksResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getImageExportTasks:getImageExportTasks", {
        "dryRun": args.dryRun,
        "filters": args.filters,
    }, opts);
}
