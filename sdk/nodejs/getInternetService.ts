 ...
 * ```
 */
export function getInternetServiceOutput(args?: GetInternetServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInternetServiceResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getInternetService:getInternetService", {
        "filters": args.filters,
    }, opts);
}
