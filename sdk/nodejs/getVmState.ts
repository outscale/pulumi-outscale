 ...
 * ```
 */
export function getVmStateOutput(args?: GetVmStateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmStateResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getVmState:getVmState", {
        "allVms": args.allVms,
        "filters": args.filters,
        "vmId": args.vmId,
    }, opts);
