 ...
 * ```
 */
export function getClientGatewaysOutput(args?: GetClientGatewaysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClientGatewaysResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getClientGateways:getClientGateways", {
        "clientGatewayIds": args.clientGatewayIds,
        "filters": args.filters,
    }, opts);
}
