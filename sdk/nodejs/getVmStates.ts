 ...
 * ```
 */
export function getVmStatesOutput(args?: GetVmStatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmStatesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getVmStates:getVmStates", {
        "allVms": args.allVms,
        "filters": args.filters,
        "vmIds": args.vmIds,
    }, opts);
