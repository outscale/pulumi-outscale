 ...
 * ```
 */
export function getNetAttributesOutput(args: GetNetAttributesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetAttributesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("outscale:index/getNetAttributes:getNetAttributes", {
        "netId": args.netId,
    }, opts);
}
