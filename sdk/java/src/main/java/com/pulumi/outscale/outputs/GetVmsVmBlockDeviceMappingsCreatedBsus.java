...
import com.pulumi.outscale.outputs.GetVmsVmBlockDeviceMappingsCreatedBsusTag;
...
@CustomType
public final class GetVmsVmBlockDeviceMappingsCreatedBsus {
    /**
     ...
     * 
     */
    private @Nullable List<GetVmsVmBlockDeviceMappingsCreatedBsusTag> tags;
    /**
    ...
    private GetVmsVmBlockDeviceMappingsCreatedBsus() {}
    /**
     * @return If true, the NIC is deleted when the VM is terminated.
     * 
     */
     ...
     * 
     */
    public List<GetVmsVmBlockDeviceMappingsCreatedBsusTag> tags() {
    ...
    public static Builder builder(GetVmsVmBlockDeviceMappingsCreatedBsus defaults) {
    ...
    public static final class Builder {
        ...
        private String volumeId;
        public Builder() {}
        public Builder(GetVmsVmBlockDeviceMappingsCreatedBsus defaults) {
        ...
        @CustomType.Setter
        public Builder tags(@Nullable List<GetVmsVmBlockDeviceMappingsCreatedBsusTag> tags) {
            this.tags = tags;
            return this;
        }
        public Builder tags(GetVmsVmBlockDeviceMappingsCreatedBsusTag... tags) {
        ...
        public GetVmsVmBlockDeviceMappingsCreatedBsus build() {
            final var o = new GetVmsVmBlockDeviceMappingsCreatedBsus();
