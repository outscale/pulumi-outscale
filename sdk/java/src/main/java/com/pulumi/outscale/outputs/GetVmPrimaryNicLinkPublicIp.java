...
@CustomType
public final class GetVmPrimaryNicLinkPublicIp {
    /**
    ...
    private GetVmPrimaryNicLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(GetVmPrimaryNicLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpAccountId;
        public Builder() {}
        public Builder(GetVmPrimaryNicLinkPublicIp defaults) {
        ...
        public GetVmPrimaryNicLinkPublicIp build() {
            final var o = new GetVmPrimaryNicLinkPublicIp();
