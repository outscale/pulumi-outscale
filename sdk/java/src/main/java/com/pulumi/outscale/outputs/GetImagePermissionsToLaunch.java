...
@CustomType
public final class GetImagePermissionsToLaunch {
    /**
    ...
    private GetImagePermissionsToLaunch() {}
    /**
     * @return The account ID of the owner of the OMI.
     * 
     */
    ...
    public static Builder builder(GetImagePermissionsToLaunch defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean globalPermission;
        public Builder() {}
        public Builder(GetImagePermissionsToLaunch defaults) {
        ...
        public GetImagePermissionsToLaunch build() {
            final var o = new GetImagePermissionsToLaunch();
