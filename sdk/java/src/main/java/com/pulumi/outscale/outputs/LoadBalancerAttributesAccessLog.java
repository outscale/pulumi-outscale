...
@CustomType
public final class LoadBalancerAttributesAccessLog {
    /**
    ...
    private LoadBalancerAttributesAccessLog() {}
    /**
     * @return If true, access logs are enabled for your load balancer. If false, they are not. If you set this to true in your request, the `osu_bucket_name` parameter is required.
     * 
     */
    ...
    public static Builder builder(LoadBalancerAttributesAccessLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer publicationInterval;
        public Builder() {}
        public Builder(LoadBalancerAttributesAccessLog defaults) {
        ...
        public LoadBalancerAttributesAccessLog build() {
            final var o = new LoadBalancerAttributesAccessLog();
