...
import com.pulumi.outscale.inputs.VmNicLinkNicArgs;
import com.pulumi.outscale.inputs.VmNicLinkPublicIpArgs;
import com.pulumi.outscale.inputs.VmNicPrivateIpArgs;
import com.pulumi.outscale.inputs.VmNicSecurityGroupArgs;
...
public final class VmNicArgs extends com.pulumi.resources.ResourceArgs {

    public static final VmNicArgs Empty = new VmNicArgs();
    ...
    private @Nullable Output<List<VmNicLinkNicArgs>> linkNics;

    /**
     * @return Information about the network interface card (NIC).
     * 
     */
    public Optional<Output<List<VmNicLinkNicArgs>>> linkNics() {
    ...
    private @Nullable Output<List<VmNicLinkPublicIpArgs>> linkPublicIps;

    /**
     * @return Information about the public IP associated with the NIC.
     * 
     */
    public Optional<Output<List<VmNicLinkPublicIpArgs>>> linkPublicIps() {
    ...
    private @Nullable Output<List<VmNicPrivateIpArgs>> privateIps;

    /**
     * @return One or more private IPs of the VM.
     * 
     */
    public Optional<Output<List<VmNicPrivateIpArgs>>> privateIps() {
    ...
    private @Nullable Output<List<VmNicSecurityGroupArgs>> securityGroups;

    /**
     * @return One or more security groups associated with the VM.
     * 
     */
    public Optional<Output<List<VmNicSecurityGroupArgs>>> securityGroups() {
    ...
    public static Builder builder(VmNicArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VmNicArgs defaults) {
            $ = new VmNicArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder linkNics(@Nullable Output<List<VmNicLinkNicArgs>> linkNics) {
            $.linkNics = linkNics;
            return this;
        }
         ...
         * 
         */
        public Builder linkNics(List<VmNicLinkNicArgs> linkNics) {
         ...
         * 
         */
        public Builder linkNics(VmNicLinkNicArgs... linkNics) {
         ...
         * 
         */
        public Builder linkPublicIps(@Nullable Output<List<VmNicLinkPublicIpArgs>> linkPublicIps) {
         ...
         * 
         */
        public Builder linkPublicIps(List<VmNicLinkPublicIpArgs> linkPublicIps) {
         ...
         * 
         */
        public Builder linkPublicIps(VmNicLinkPublicIpArgs... linkPublicIps) {
         ...
         * 
         */
        public Builder privateIps(@Nullable Output<List<VmNicPrivateIpArgs>> privateIps) {
         ...
         * 
         */
        public Builder privateIps(List<VmNicPrivateIpArgs> privateIps) {
         ...
         * 
         */
        public Builder privateIps(VmNicPrivateIpArgs... privateIps) {
         ...
         * 
         */
        public Builder securityGroups(@Nullable Output<List<VmNicSecurityGroupArgs>> securityGroups) {
         ...
         * 
         */
        public Builder securityGroups(List<VmNicSecurityGroupArgs> securityGroups) {
         ...
         * 
         */
        public Builder securityGroups(VmNicSecurityGroupArgs... securityGroups) {
