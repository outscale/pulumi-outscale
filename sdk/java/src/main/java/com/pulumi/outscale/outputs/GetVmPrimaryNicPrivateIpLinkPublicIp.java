...
@CustomType
public final class GetVmPrimaryNicPrivateIpLinkPublicIp {
    /**
    ...
    private GetVmPrimaryNicPrivateIpLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(GetVmPrimaryNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpAccountId;
        public Builder() {}
        public Builder(GetVmPrimaryNicPrivateIpLinkPublicIp defaults) {
        ...
        public GetVmPrimaryNicPrivateIpLinkPublicIp build() {
            final var o = new GetVmPrimaryNicPrivateIpLinkPublicIp();
