...
@CustomType
public final class NicLinkPublicIp {
    /**
    ...
    public static Builder builder(NicLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String publicIpId;
        public Builder() {}
        public Builder(NicLinkPublicIp defaults) {
        ...
        public NicLinkPublicIp build() {
            final var o = new NicLinkPublicIp();
