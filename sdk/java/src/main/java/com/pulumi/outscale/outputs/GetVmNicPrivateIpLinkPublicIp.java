...
@CustomType
public final class GetVmNicPrivateIpLinkPublicIp {
    /**
    ...
    private GetVmNicPrivateIpLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(GetVmNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpAccountId;
        public Builder() {}
        public Builder(GetVmNicPrivateIpLinkPublicIp defaults) {
        ...
        public GetVmNicPrivateIpLinkPublicIp build() {
            final var o = new GetVmNicPrivateIpLinkPublicIp();
