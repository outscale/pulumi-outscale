...
@CustomType
public final class NetPeeringAcceptionAccepterNet {
    /**
    ...
    private NetPeeringAcceptionAccepterNet() {}
    /**
     * @return The account ID of the owner of the source Net.
     * 
     */
    ...
    public static Builder builder(NetPeeringAcceptionAccepterNet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String netId;
        public Builder() {}
        public Builder(NetPeeringAcceptionAccepterNet defaults) {
        ...
        public NetPeeringAcceptionAccepterNet build() {
            final var o = new NetPeeringAcceptionAccepterNet();
