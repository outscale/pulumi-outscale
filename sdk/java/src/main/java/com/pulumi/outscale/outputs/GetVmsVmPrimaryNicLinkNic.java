...
@CustomType
public final class GetVmsVmPrimaryNicLinkNic {
    /**
    ...
    private GetVmsVmPrimaryNicLinkNic() {}
    /**
     * @return If true, the NIC is deleted when the VM is terminated.
     * 
     */
    ...
    public static Builder builder(GetVmsVmPrimaryNicLinkNic defaults) {
    ...
    public static final class Builder {
        ...
        private String state;
        public Builder() {}
        public Builder(GetVmsVmPrimaryNicLinkNic defaults) {
        ...
        public GetVmsVmPrimaryNicLinkNic build() {
            final var o = new GetVmsVmPrimaryNicLinkNic();
