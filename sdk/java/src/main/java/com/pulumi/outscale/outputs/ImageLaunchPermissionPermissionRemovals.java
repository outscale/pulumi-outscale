...
@CustomType
public final class ImageLaunchPermissionPermissionRemovals {
    /**
    ...
    private ImageLaunchPermissionPermissionRemovals() {}
    /**
     * @return The account ID of one or more users from whom you want to remove permissions.
     * 
     */
    ...
    public static Builder builder(ImageLaunchPermissionPermissionRemovals defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String globalPermission;
        public Builder() {}
        public Builder(ImageLaunchPermissionPermissionRemovals defaults) {
        ...
        public ImageLaunchPermissionPermissionRemovals build() {
            final var o = new ImageLaunchPermissionPermissionRemovals();
