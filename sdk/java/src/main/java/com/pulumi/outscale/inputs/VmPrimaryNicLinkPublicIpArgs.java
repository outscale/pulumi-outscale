...
public final class VmPrimaryNicLinkPublicIpArgs extends com.pulumi.resources.ResourceArgs {

    public static final VmPrimaryNicLinkPublicIpArgs Empty = new VmPrimaryNicLinkPublicIpArgs();
    ...
    private VmPrimaryNicLinkPublicIpArgs() {}

    private VmPrimaryNicLinkPublicIpArgs(VmPrimaryNicLinkPublicIpArgs $) {
    ...
    public static Builder builder(VmPrimaryNicLinkPublicIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VmPrimaryNicLinkPublicIpArgs();
        }

        public Builder(VmPrimaryNicLinkPublicIpArgs defaults) {
            $ = new VmPrimaryNicLinkPublicIpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VmPrimaryNicLinkPublicIpArgs build() {
            return $;
        }
    }
