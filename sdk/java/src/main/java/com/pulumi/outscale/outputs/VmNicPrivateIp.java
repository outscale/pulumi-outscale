...
import com.pulumi.outscale.outputs.VmNicPrivateIpLinkPublicIp;
...
@CustomType
public final class VmNicPrivateIp {
    /**
     ...
     * 
     */
    private @Nullable List<VmNicPrivateIpLinkPublicIp> linkPublicIps;
    /**
     ...
     * 
     */
    public List<VmNicPrivateIpLinkPublicIp> linkPublicIps() {
    ...
    public static Builder builder(VmNicPrivateIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String privateIp;
        public Builder() {}
        public Builder(VmNicPrivateIp defaults) {
        ...
        @CustomType.Setter
        public Builder linkPublicIps(@Nullable List<VmNicPrivateIpLinkPublicIp> linkPublicIps) {
            this.linkPublicIps = linkPublicIps;
            return this;
        }
        public Builder linkPublicIps(VmNicPrivateIpLinkPublicIp... linkPublicIps) {
        ...
        public VmNicPrivateIp build() {
            final var o = new VmNicPrivateIp();
