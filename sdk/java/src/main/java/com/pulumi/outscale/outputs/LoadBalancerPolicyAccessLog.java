...
@CustomType
public final class LoadBalancerPolicyAccessLog {
    /**
    ...
    public static Builder builder(LoadBalancerPolicyAccessLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer publicationInterval;
        public Builder() {}
        public Builder(LoadBalancerPolicyAccessLog defaults) {
        ...
        public LoadBalancerPolicyAccessLog build() {
            final var o = new LoadBalancerPolicyAccessLog();
