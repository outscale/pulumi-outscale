...
@CustomType
public final class NicSecurityGroup {
    /**
    ...
    public static Builder builder(NicSecurityGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String securityGroupName;
        public Builder() {}
        public Builder(NicSecurityGroup defaults) {
        ...
        public NicSecurityGroup build() {
            final var o = new NicSecurityGroup();
