...
public final class NetPeeringAcceptionSourceNetArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetPeeringAcceptionSourceNetArgs Empty = new NetPeeringAcceptionSourceNetArgs();
    ...
    private NetPeeringAcceptionSourceNetArgs() {}

    private NetPeeringAcceptionSourceNetArgs(NetPeeringAcceptionSourceNetArgs $) {
    ...
    public static Builder builder(NetPeeringAcceptionSourceNetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetPeeringAcceptionSourceNetArgs();
        }

        public Builder(NetPeeringAcceptionSourceNetArgs defaults) {
            $ = new NetPeeringAcceptionSourceNetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetPeeringAcceptionSourceNetArgs build() {
            return $;
        }
    }
