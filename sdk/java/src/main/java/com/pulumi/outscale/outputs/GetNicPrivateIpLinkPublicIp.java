...
@CustomType
public final class GetNicPrivateIpLinkPublicIp {
    /**
    ...
    private GetNicPrivateIpLinkPublicIp() {}
    /**
     * @return (Required in a Net) The ID representing the association of the public IP with the VM or the NIC.
     * 
     */
    ...
    public static Builder builder(GetNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpId;
        public Builder() {}
        public Builder(GetNicPrivateIpLinkPublicIp defaults) {
        ...
        public GetNicPrivateIpLinkPublicIp build() {
            final var o = new GetNicPrivateIpLinkPublicIp();
