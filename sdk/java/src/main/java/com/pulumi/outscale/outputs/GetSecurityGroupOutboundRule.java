...
import com.pulumi.outscale.outputs.GetSecurityGroupOutboundRuleSecurityGroupsMember;
...
@CustomType
public final class GetSecurityGroupOutboundRule {
    /**
     ...
     * 
     */
    private List<GetSecurityGroupOutboundRuleSecurityGroupsMember> securityGroupsMembers;
    /**
    ...
    private GetSecurityGroupOutboundRule() {}
    /**
     * @return The beginning of the port range for the TCP and UDP protocols, or an ICMP type number.
     * 
     */
     ...
     * 
     */
    public List<GetSecurityGroupOutboundRuleSecurityGroupsMember> securityGroupsMembers() {
    ...
    public static Builder builder(GetSecurityGroupOutboundRule defaults) {
    ...
    public static final class Builder {
        ...
        private Integer toPortRange;
        public Builder() {}
        public Builder(GetSecurityGroupOutboundRule defaults) {
        ...
        @CustomType.Setter
        public Builder securityGroupsMembers(List<GetSecurityGroupOutboundRuleSecurityGroupsMember> securityGroupsMembers) {
            this.securityGroupsMembers = Objects.requireNonNull(securityGroupsMembers);
            return this;
        }
        public Builder securityGroupsMembers(GetSecurityGroupOutboundRuleSecurityGroupsMember... securityGroupsMembers) {
        ...
        public GetSecurityGroupOutboundRule build() {
            final var o = new GetSecurityGroupOutboundRule();
