...
@CustomType
public final class GetNetPeeringAccepterNet {
    /**
    ...
    private GetNetPeeringAccepterNet() {}
    /**
     * @return The account ID of the owner of the source Net.
     * 
     */
    ...
    public static Builder builder(GetNetPeeringAccepterNet defaults) {
    ...
    public static final class Builder {
        ...
        private String netId;
        public Builder() {}
        public Builder(GetNetPeeringAccepterNet defaults) {
        ...
        public GetNetPeeringAccepterNet build() {
            final var o = new GetNetPeeringAccepterNet();
