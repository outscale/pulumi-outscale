...
@CustomType
public final class GetVmsVmPrimaryNicPrivateIpLinkPublicIp {
    /**
    ...
    private GetVmsVmPrimaryNicPrivateIpLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(GetVmsVmPrimaryNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpAccountId;
        public Builder() {}
        public Builder(GetVmsVmPrimaryNicPrivateIpLinkPublicIp defaults) {
        ...
        public GetVmsVmPrimaryNicPrivateIpLinkPublicIp build() {
            final var o = new GetVmsVmPrimaryNicPrivateIpLinkPublicIp();
