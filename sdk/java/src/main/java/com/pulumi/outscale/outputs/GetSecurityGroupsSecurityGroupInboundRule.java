...
import com.pulumi.outscale.outputs.GetSecurityGroupsSecurityGroupInboundRuleSecurityGroupsMember;
...
@CustomType
public final class GetSecurityGroupsSecurityGroupInboundRule {
    /**
     ...
     * 
     */
    private List<GetSecurityGroupsSecurityGroupInboundRuleSecurityGroupsMember> securityGroupsMembers;
    /**
    ...
    private GetSecurityGroupsSecurityGroupInboundRule() {}
    /**
     * @return The beginning of the port range for the TCP and UDP protocols, or an ICMP type number.
     * 
     */
     ...
     * 
     */
    public List<GetSecurityGroupsSecurityGroupInboundRuleSecurityGroupsMember> securityGroupsMembers() {
    ...
    public static Builder builder(GetSecurityGroupsSecurityGroupInboundRule defaults) {
    ...
    public static final class Builder {
        ...
        private Integer toPortRange;
        public Builder() {}
        public Builder(GetSecurityGroupsSecurityGroupInboundRule defaults) {
        ...
        @CustomType.Setter
        public Builder securityGroupsMembers(List<GetSecurityGroupsSecurityGroupInboundRuleSecurityGroupsMember> securityGroupsMembers) {
            this.securityGroupsMembers = Objects.requireNonNull(securityGroupsMembers);
            return this;
        }
        public Builder securityGroupsMembers(GetSecurityGroupsSecurityGroupInboundRuleSecurityGroupsMember... securityGroupsMembers) {
        ...
        public GetSecurityGroupsSecurityGroupInboundRule build() {
            final var o = new GetSecurityGroupsSecurityGroupInboundRule();
