...
@CustomType
public final class GetNicsNicLinkPublicIp {
    /**
    ...
    private GetNicsNicLinkPublicIp() {}
    /**
     * @return (Required in a Net) The ID representing the association of the public IP with the VM or the NIC.
     * 
     */
    ...
    public static Builder builder(GetNicsNicLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpId;
        public Builder() {}
        public Builder(GetNicsNicLinkPublicIp defaults) {
        ...
        public GetNicsNicLinkPublicIp build() {
            final var o = new GetNicsNicLinkPublicIp();
