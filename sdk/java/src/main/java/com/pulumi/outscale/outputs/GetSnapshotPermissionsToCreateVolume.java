...
@CustomType
public final class GetSnapshotPermissionsToCreateVolume {
    /**
    ...
    private GetSnapshotPermissionsToCreateVolume() {}
    /**
     * @return The account IDs of the owners of the snapshots.
     * 
     */
    ...
    public static Builder builder(GetSnapshotPermissionsToCreateVolume defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean globalPermission;
        public Builder() {}
        public Builder(GetSnapshotPermissionsToCreateVolume defaults) {
        ...
        public GetSnapshotPermissionsToCreateVolume build() {
            final var o = new GetSnapshotPermissionsToCreateVolume();
