...
@CustomType
public final class VmPrimaryNicLinkNic {
    /**
    ...
    public static Builder builder(VmPrimaryNicLinkNic defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(VmPrimaryNicLinkNic defaults) {
        ...
        public VmPrimaryNicLinkNic build() {
            final var o = new VmPrimaryNicLinkNic();
