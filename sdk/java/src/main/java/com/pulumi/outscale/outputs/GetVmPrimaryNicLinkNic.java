...
@CustomType
public final class GetVmPrimaryNicLinkNic {
    /**
    ...
    private GetVmPrimaryNicLinkNic() {}
    /**
     * @return If true, the NIC is deleted when the VM is terminated.
     * 
     */
    ...
    public static Builder builder(GetVmPrimaryNicLinkNic defaults) {
    ...
    public static final class Builder {
        ...
        private String state;
        public Builder() {}
        public Builder(GetVmPrimaryNicLinkNic defaults) {
        ...
        public GetVmPrimaryNicLinkNic build() {
            final var o = new GetVmPrimaryNicLinkNic();
