...
import com.pulumi.outscale.inputs.GetCaFilter;
...
public final class GetCaPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetCaPlainArgs Empty = new GetCaPlainArgs();
     ...
     * 
     */
    public Optional<List<GetCaFilter>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetCaPlainArgs() {}

    private GetCaPlainArgs(GetCaPlainArgs $) {
    ...
    public static Builder builder(GetCaPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetCaPlainArgs defaults) {
            $ = new GetCaPlainArgs(Objects.requireNonNull(defaults));
        }
