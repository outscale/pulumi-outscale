...
@CustomType
public final class VmNicPrivateIpLinkPublicIp {
    /**
    ...
    private VmNicPrivateIpLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(VmNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String publicIpAccountId;
        public Builder() {}
        public Builder(VmNicPrivateIpLinkPublicIp defaults) {
        ...
        public VmNicPrivateIpLinkPublicIp build() {
            final var o = new VmNicPrivateIpLinkPublicIp();
