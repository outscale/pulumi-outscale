...
public final class ImageLaunchPermissionPermissionAdditionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImageLaunchPermissionPermissionAdditionsArgs Empty = new ImageLaunchPermissionPermissionAdditionsArgs();
    ...
    private ImageLaunchPermissionPermissionAdditionsArgs() {}

    private ImageLaunchPermissionPermissionAdditionsArgs(ImageLaunchPermissionPermissionAdditionsArgs $) {
    ...
    public static Builder builder(ImageLaunchPermissionPermissionAdditionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImageLaunchPermissionPermissionAdditionsArgs();
        }

        public Builder(ImageLaunchPermissionPermissionAdditionsArgs defaults) {
            $ = new ImageLaunchPermissionPermissionAdditionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ImageLaunchPermissionPermissionAdditionsArgs build() {
            return $;
        }
    }
