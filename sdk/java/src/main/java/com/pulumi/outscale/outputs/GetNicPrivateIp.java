...
import com.pulumi.outscale.outputs.GetNicPrivateIpLinkPublicIp;
...
@CustomType
public final class GetNicPrivateIp {
    /**
     ...
     * 
     */
    private List<GetNicPrivateIpLinkPublicIp> linkPublicIps;
    /**
     ...
     * 
     */
    public List<GetNicPrivateIpLinkPublicIp> linkPublicIps() {
    ...
    public static Builder builder(GetNicPrivateIp defaults) {
    ...
    public static final class Builder {
        ...
        private String privateIp;
        public Builder() {}
        public Builder(GetNicPrivateIp defaults) {
        ...
        @CustomType.Setter
        public Builder linkPublicIps(List<GetNicPrivateIpLinkPublicIp> linkPublicIps) {
            this.linkPublicIps = Objects.requireNonNull(linkPublicIps);
            return this;
        }
        public Builder linkPublicIps(GetNicPrivateIpLinkPublicIp... linkPublicIps) {
        ...
        public GetNicPrivateIp build() {
            final var o = new GetNicPrivateIp();
