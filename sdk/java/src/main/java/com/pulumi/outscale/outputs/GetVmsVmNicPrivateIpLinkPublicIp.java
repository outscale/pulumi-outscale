...
@CustomType
public final class GetVmsVmNicPrivateIpLinkPublicIp {
    /**
    ...
    private GetVmsVmNicPrivateIpLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(GetVmsVmNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpAccountId;
        public Builder() {}
        public Builder(GetVmsVmNicPrivateIpLinkPublicIp defaults) {
        ...
        public GetVmsVmNicPrivateIpLinkPublicIp build() {
            final var o = new GetVmsVmNicPrivateIpLinkPublicIp();
