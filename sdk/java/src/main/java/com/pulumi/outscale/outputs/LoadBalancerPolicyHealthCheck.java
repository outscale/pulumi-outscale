...
@CustomType
public final class LoadBalancerPolicyHealthCheck {
    /**
    ...
    private LoadBalancerPolicyHealthCheck() {}
    /**
     * @return The number of seconds between two pings (between `5` and `600` both included).
     * 
     */
    ...
    public static Builder builder(LoadBalancerPolicyHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer unhealthyThreshold;
        public Builder() {}
        public Builder(LoadBalancerPolicyHealthCheck defaults) {
        ...
        public LoadBalancerPolicyHealthCheck build() {
            final var o = new LoadBalancerPolicyHealthCheck();
