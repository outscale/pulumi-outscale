...
public final class SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs Empty = new SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs();
    ...
    private SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs() {}

    private SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs(SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs $) {
    ...
    public static Builder builder(SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs();
        }

        public Builder(SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs defaults) {
            $ = new SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SnapshotAttributesPermissionsToCreateVolumeAdditionsArgs build() {
            return $;
        }
    }
