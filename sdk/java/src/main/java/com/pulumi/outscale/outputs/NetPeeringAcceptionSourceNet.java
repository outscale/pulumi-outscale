...
@CustomType
public final class NetPeeringAcceptionSourceNet {
    /**
    ...
    private NetPeeringAcceptionSourceNet() {}
    /**
     * @return The account ID of the owner of the source Net.
     * 
     */
    ...
    public static Builder builder(NetPeeringAcceptionSourceNet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String netId;
        public Builder() {}
        public Builder(NetPeeringAcceptionSourceNet defaults) {
        ...
        public NetPeeringAcceptionSourceNet build() {
            final var o = new NetPeeringAcceptionSourceNet();
