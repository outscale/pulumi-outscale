...
public final class SnapshotExportTaskState extends com.pulumi.resources.ResourceArgs {

    public static final SnapshotExportTaskState Empty = new SnapshotExportTaskState();
    ...
    private @Nullable Output<List<SnapshotExportTaskOsuExportArgs>> osuExports;

    /**
     * @return Information about the OOS export task to create.
     * 
     */
    public Optional<Output<List<SnapshotExportTaskOsuExportArgs>>> osuExports() {
    ...
    private SnapshotExportTaskState() {}

    private SnapshotExportTaskState(SnapshotExportTaskState $) {
    ...
    public static Builder builder(SnapshotExportTaskState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SnapshotExportTaskState();
        }

        public Builder(SnapshotExportTaskState defaults) {
            $ = new SnapshotExportTaskState(Objects.requireNonNull(defaults));
        }

        /**
         * @param comment If the snapshot export task fails, an error message appears.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder osuExports(@Nullable Output<List<SnapshotExportTaskOsuExportArgs>> osuExports) {
        ...
        /**
         * @param progress The progress of the snapshot export task, as a percentage.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param state The state of the snapshot export task (`pending` \| `active` \| `completed` \| `failed`).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param taskId The ID of the snapshot export task.
         * 
         * @return builder
         * 
         */
        ...
        public SnapshotExportTaskState build() {
            return $;
        }
    }
