...
@CustomType
public final class SnapshotAttributesPermissionsToCreateVolumeRemoval {
    /**
    ...
    public static Builder builder(SnapshotAttributesPermissionsToCreateVolumeRemoval defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean globalPermission;
        public Builder() {}
        public Builder(SnapshotAttributesPermissionsToCreateVolumeRemoval defaults) {
        ...
        public SnapshotAttributesPermissionsToCreateVolumeRemoval build() {
            final var o = new SnapshotAttributesPermissionsToCreateVolumeRemoval();
