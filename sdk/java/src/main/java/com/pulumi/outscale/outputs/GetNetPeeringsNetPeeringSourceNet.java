...
@CustomType
public final class GetNetPeeringsNetPeeringSourceNet {
    /**
    ...
    private GetNetPeeringsNetPeeringSourceNet() {}
    /**
     * @return The account ID of the owner of the source Net.
     * 
     */
    ...
    public static Builder builder(GetNetPeeringsNetPeeringSourceNet defaults) {
    ...
    public static final class Builder {
        ...
        private String netId;
        public Builder() {}
        public Builder(GetNetPeeringsNetPeeringSourceNet defaults) {
        ...
        public GetNetPeeringsNetPeeringSourceNet build() {
            final var o = new GetNetPeeringsNetPeeringSourceNet();
