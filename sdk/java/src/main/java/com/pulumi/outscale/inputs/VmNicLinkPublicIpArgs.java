...
public final class VmNicLinkPublicIpArgs extends com.pulumi.resources.ResourceArgs {

    public static final VmNicLinkPublicIpArgs Empty = new VmNicLinkPublicIpArgs();
    ...
    private VmNicLinkPublicIpArgs() {}

    private VmNicLinkPublicIpArgs(VmNicLinkPublicIpArgs $) {
    ...
    public static Builder builder(VmNicLinkPublicIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VmNicLinkPublicIpArgs();
        }

        public Builder(VmNicLinkPublicIpArgs defaults) {
            $ = new VmNicLinkPublicIpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VmNicLinkPublicIpArgs build() {
            return $;
        }
    }
