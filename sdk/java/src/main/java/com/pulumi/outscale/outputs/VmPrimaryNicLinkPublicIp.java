...
@CustomType
public final class VmPrimaryNicLinkPublicIp {
    /**
    ...
    private VmPrimaryNicLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(VmPrimaryNicLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String publicIpAccountId;
        public Builder() {}
        public Builder(VmPrimaryNicLinkPublicIp defaults) {
        ...
        public VmPrimaryNicLinkPublicIp build() {
            final var o = new VmPrimaryNicLinkPublicIp();
