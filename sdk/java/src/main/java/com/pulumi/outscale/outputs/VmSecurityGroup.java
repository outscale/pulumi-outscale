...
@CustomType
public final class VmSecurityGroup {
    /**
    ...
    public static Builder builder(VmSecurityGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String securityGroupName;
        public Builder() {}
        public Builder(VmSecurityGroup defaults) {
        ...
        public VmSecurityGroup build() {
            final var o = new VmSecurityGroup();
