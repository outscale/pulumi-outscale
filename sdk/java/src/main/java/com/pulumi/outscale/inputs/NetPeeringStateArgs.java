...
public final class NetPeeringStateArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetPeeringStateArgs Empty = new NetPeeringStateArgs();
    ...
    private NetPeeringStateArgs() {}

    private NetPeeringStateArgs(NetPeeringStateArgs $) {
    ...
    public static Builder builder(NetPeeringStateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetPeeringStateArgs();
        }

        public Builder(NetPeeringStateArgs defaults) {
            $ = new NetPeeringStateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetPeeringStateArgs build() {
            return $;
        }
    }
