...
@CustomType
public final class GetNetPeeringsNetPeeringAccepterNet {
    /**
    ...
    private GetNetPeeringsNetPeeringAccepterNet() {}
    /**
     * @return The account ID of the owner of the source Net.
     * 
     */
    ...
    public static Builder builder(GetNetPeeringsNetPeeringAccepterNet defaults) {
    ...
    public static final class Builder {
        ...
        private String netId;
        public Builder() {}
        public Builder(GetNetPeeringsNetPeeringAccepterNet defaults) {
        ...
        public GetNetPeeringsNetPeeringAccepterNet build() {
            final var o = new GetNetPeeringsNetPeeringAccepterNet();
