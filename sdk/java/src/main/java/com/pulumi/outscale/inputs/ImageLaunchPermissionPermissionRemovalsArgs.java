...
public final class ImageLaunchPermissionPermissionRemovalsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImageLaunchPermissionPermissionRemovalsArgs Empty = new ImageLaunchPermissionPermissionRemovalsArgs();
    ...
    private ImageLaunchPermissionPermissionRemovalsArgs() {}

    private ImageLaunchPermissionPermissionRemovalsArgs(ImageLaunchPermissionPermissionRemovalsArgs $) {
    ...
    public static Builder builder(ImageLaunchPermissionPermissionRemovalsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImageLaunchPermissionPermissionRemovalsArgs();
        }

        public Builder(ImageLaunchPermissionPermissionRemovalsArgs defaults) {
            $ = new ImageLaunchPermissionPermissionRemovalsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ImageLaunchPermissionPermissionRemovalsArgs build() {
            return $;
        }
    }
