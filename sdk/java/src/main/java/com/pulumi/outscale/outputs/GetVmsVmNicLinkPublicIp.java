...
@CustomType
public final class GetVmsVmNicLinkPublicIp {
    /**
    ...
    private GetVmsVmNicLinkPublicIp() {}
    /**
     * @return The name of the public DNS.
     * 
     */
    ...
    public static Builder builder(GetVmsVmNicLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpAccountId;
        public Builder() {}
        public Builder(GetVmsVmNicLinkPublicIp defaults) {
        ...
        public GetVmsVmNicLinkPublicIp build() {
            final var o = new GetVmsVmNicLinkPublicIp();
