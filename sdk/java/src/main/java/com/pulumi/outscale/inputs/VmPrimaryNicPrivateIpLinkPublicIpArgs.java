...
public final class VmPrimaryNicPrivateIpLinkPublicIpArgs extends com.pulumi.resources.ResourceArgs {

    public static final VmPrimaryNicPrivateIpLinkPublicIpArgs Empty = new VmPrimaryNicPrivateIpLinkPublicIpArgs();
    ...
    private VmPrimaryNicPrivateIpLinkPublicIpArgs() {}

    private VmPrimaryNicPrivateIpLinkPublicIpArgs(VmPrimaryNicPrivateIpLinkPublicIpArgs $) {
    ...
    public static Builder builder(VmPrimaryNicPrivateIpLinkPublicIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VmPrimaryNicPrivateIpLinkPublicIpArgs();
        }

        public Builder(VmPrimaryNicPrivateIpLinkPublicIpArgs defaults) {
            $ = new VmPrimaryNicPrivateIpLinkPublicIpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VmPrimaryNicPrivateIpLinkPublicIpArgs build() {
            return $;
        }
    }
