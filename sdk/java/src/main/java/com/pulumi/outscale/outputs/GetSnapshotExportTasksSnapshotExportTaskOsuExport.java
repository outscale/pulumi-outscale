...
@CustomType
public final class GetSnapshotExportTasksSnapshotExportTaskOsuExport {
    /**
    ...
    private GetSnapshotExportTasksSnapshotExportTaskOsuExport() {}
    /**
     * @return The format of the export disk (`qcow2` \| `raw`).
     * 
     */
    ...
    public static Builder builder(GetSnapshotExportTasksSnapshotExportTaskOsuExport defaults) {
    ...
    public static final class Builder {
        ...
        private String osuPrefix;
        public Builder() {}
        public Builder(GetSnapshotExportTasksSnapshotExportTaskOsuExport defaults) {
        ...
        public GetSnapshotExportTasksSnapshotExportTaskOsuExport build() {
            final var o = new GetSnapshotExportTasksSnapshotExportTaskOsuExport();
