...
public final class DhcpOptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DhcpOptionArgs Empty = new DhcpOptionArgs();
    ...
    private DhcpOptionArgs() {}

    private DhcpOptionArgs(DhcpOptionArgs $) {
    ...
    public static Builder builder(DhcpOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DhcpOptionArgs defaults) {
            $ = new DhcpOptionArgs(Objects.requireNonNull(defaults));
        }
