...
@CustomType
public final class GetNicsNicPrivateIpLinkPublicIp {
    /**
    ...
    private GetNicsNicPrivateIpLinkPublicIp() {}
    /**
     * @return (Required in a Net) The ID representing the association of the public IP with the VM or the NIC.
     * 
     */
    ...
    public static Builder builder(GetNicsNicPrivateIpLinkPublicIp defaults) {
    ...
    public static final class Builder {
        ...
        private String publicIpId;
        public Builder() {}
        public Builder(GetNicsNicPrivateIpLinkPublicIp defaults) {
        ...
        public GetNicsNicPrivateIpLinkPublicIp build() {
            final var o = new GetNicsNicPrivateIpLinkPublicIp();
