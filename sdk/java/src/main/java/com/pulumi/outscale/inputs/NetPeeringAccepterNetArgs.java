...
public final class NetPeeringAccepterNetArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetPeeringAccepterNetArgs Empty = new NetPeeringAccepterNetArgs();
    ...
    private NetPeeringAccepterNetArgs() {}

    private NetPeeringAccepterNetArgs(NetPeeringAccepterNetArgs $) {
    ...
    public static Builder builder(NetPeeringAccepterNetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetPeeringAccepterNetArgs();
        }

        public Builder(NetPeeringAccepterNetArgs defaults) {
            $ = new NetPeeringAccepterNetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetPeeringAccepterNetArgs build() {
            return $;
        }
    }
