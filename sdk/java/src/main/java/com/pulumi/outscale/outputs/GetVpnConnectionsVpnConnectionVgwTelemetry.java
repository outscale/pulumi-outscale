...
@CustomType
public final class GetVpnConnectionsVpnConnectionVgwTelemetry {
    /**
    ...
    private GetVpnConnectionsVpnConnectionVgwTelemetry() {}
    /**
     * @return The number of routes accepted through BGP (Border Gateway Protocol) route exchanges.
     * 
     */
    ...
    public static Builder builder(GetVpnConnectionsVpnConnectionVgwTelemetry defaults) {
    ...
    public static final class Builder {
        ...
        private String stateDescription;
        public Builder() {}
        public Builder(GetVpnConnectionsVpnConnectionVgwTelemetry defaults) {
        ...
        public GetVpnConnectionsVpnConnectionVgwTelemetry build() {
            final var o = new GetVpnConnectionsVpnConnectionVgwTelemetry();
